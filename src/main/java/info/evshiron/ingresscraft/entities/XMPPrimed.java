 ...
 */
public class XMPPrimed extends Entity {
    ...
    public XMPPrimed(World p_i1729_1_)
    {
    ...
    public XMPPrimed(World p_i1730_1_, double p_i1730_2_, double p_i1730_4_, double p_i1730_6_, EntityLivingBase p_i1730_8_)
    {
        this(p_i1730_1_);
    ...
    {
        float f = 50.0F;
        OExplosion explosion = new OExplosion(this.worldObj,this, this.posX, this.posY, this.posZ, 10.0F);
